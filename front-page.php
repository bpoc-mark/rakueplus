...
<section class="sect_1">
    <div class="sect_1__wrapper">
        <div class="images cont_slider">
            ...
            <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/release/image/sect_1/img_2.png" alt="">
            </div>
            <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/release/image/sect_1/img_3.png" alt="">
            </div>
            <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/release/image/sect_1/img_4.png" alt="">
            </div>
            <div class="img">
        ...
        <div class="l-wrap">
            <div class="content">
                <div class="content__col-1">
                    <img src="<?php echo get_template_directory_uri(); ?>/release/image/sect_1/img_6.png" alt="">
                </div>
                ...
                <div class="content__col-2">
                    ...
                    <p class="desc">説明文が入る。説明文が入る。説明文が入る。説明文が入る。説明文が入る。 説明文が入る。説明文が入る。説明文が入る。説明文が入る。説明文が入る。
                        説明文が入る。説明文が入る。説明文が入る。説明文が入る。説明文が入る。 説明文が入る。説明文が入る。説明文が入る。</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="sect_2">
    <div class="sect_2__wrapper">
        <div class="l-wrap">
            <div class="c-contact">
                <div class="img_1">
                    <img src="<?php echo get_template_directory_uri(); ?>/release/image/sect_5/arrow_right.png"
                        alt="Arrow Right">
                </div>
                <div class="img_2">
                ...
                <div class="img_5">
                    <img class="pc"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/sect_5/contact_woman.png"
                        alt="Woman">
                    <img class="sp"
                        src="<?php echo get_template_directory_uri(); ?>/release/image/sect_5/contact_woman_sp.png"
                        alt="Woman">
                </div>
            </div>
        </div>
    ...
    <div class="l-wrap">
        ...
        <div class="sect_3__boxes">
            <div class="box">
                ...
                <p>RAKUEという商品自体の
                    良さで勝負できる</p>
                <p>『省エネ効果No1アイテム』それは「窓」です。あまり知られていませんがその効果は絶大！
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="col_heading">
                        <img src="<?= get_template_directory_uri(); ?>/release/image/sect_6/img_1.png"
                            alt="RAKUE + 松 プラン">
                    </div>

                    <div class="body">
                        <div>
                            <img src="<?= get_template_directory_uri(); ?>/release/image/sect_6/icon_1.png"
                                alt="Plus Sign">
                            <p>営業マニュアルのお渡し</p>
                        </div>
                        <div>
                ...
                <div class="col">
                    <div class="col_heading">
                        <img src="<?= get_template_directory_uri(); ?>/release/image/sect_6/img_2.png"
                            alt="RAKUE + 竹 プラン">
                    </div>
                ...
                <div class="col">
                    <div class="col_heading">
                        <img src="<?= get_template_directory_uri(); ?>/release/image/sect_6/img_3.png"
                            alt="RAKUE + 梅 プラン">
                    </div>
...
<section class="sect_7">
    <div class="sect_7__wrapper">
        <div class="l-wrap">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="col_heading">
                        <p>質問タイトルが入ります <br>
                            質問タイトルが入ります</p>
                        <img src="<?= get_template_directory_uri(); ?>/release/image/sect_7/rectangle.png"
                            alt="rectangle">
                    </div>
            ...
            <img src="<?= get_template_directory_uri(); ?>/release/image/sect_7/img_1_sp.png" alt="Girl"
                class="girl_sp">
        </div>
    </div>
</section>
<section class="sect_8">
    <div class="sect_8__wrapper">
        <div class="l-wrap">
            ...
            <p class="l-wrap__desc w-620 m-b-80">
                ・お問い合わせフォームに必要事項のご入力をして送信ボタンをクリックしてください。<br>
                ・メールアドレスは正しくご入力ください。弊社より返信メールが届かない可能性があります。<br>
                ・【必須】の項目は必ず入力してください。
            </p>
